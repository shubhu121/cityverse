...
window.onload = function () {
  ...
  setTimeout(function () {
    ...
    window.setColor('c1');
    window.write('moncity --run', 80, 500, function () {
      window.newLine();
      // platform check
      if (isMobile()) {
        window.newLine();
        ...
        // logo
        window.setColor('g1');
        window.write('   _____                       .__  __          ', 0, 0, function () {
          window.newLine();
          window.setColor('g1');
          window.write('  /     \\   ____   ____   ____ |__|/  |_ ___.__.', 0, 0, function () {
            window.newLine();
            window.setColor('g2');
            window.write(' /  \\ /  \\ /  _ \\ /    \\_/ ___\\|  \\   __<   |  |', 0, 0, function () {
              window.newLine();
              window.setColor('g3');
              window.write('/    Y    (  <_> )   |  \\  \\___|  ||  |  \\___  |', 0, 0, function () {
                window.newLine();
                window.setColor('g4');
                window.write('\\____|__  /\\____/|___|  /\\___  >__||__|  / ____|', 0, 0, function () {
                  window.newLine();
                  window.setColor('g5');
                  window.write('        \\/            \\/     \\/          \\/     ', 0, 0, function () {
                    ...
                    window.newLine();
                    window.setColor('g1');
                    window.write('   an interactive audiovisual experience to discover monad projects', 0, 0, function () {
                      window.newLine();
                      window.newLine();
                      ...
                      window.write('▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚', 0, 800, function () {
                        ...
                        window.write('>> initiating boot sequence...', 0, 500, function () {
                          ...
                          window.write('build version: ' + version, 0, 50, function () {
                            window.newLine();
                            window.write('system manufacturer: shubhu [x.com/positronx_]', 0, 50, function () {
                              window.newLine();
...
window.showCredits = function () {
  setTimeout(function () {
    ...
    window.newLine();
    window.setColor('c1');
    window.write('moncity --credits', 80, 800, function () {
      window.newLine();
      window.newLine();
      window.setColor('c4');
